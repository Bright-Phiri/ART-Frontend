      ...
      <v-col cols="12">
        <v-card shaped class="elevation-7">
          <v-card-title class="d-flex mt-0">
            ...
            <v-spacer></v-spacer>
            <v-btn class="mr-2 ml-4 text-capitalize" outlined small dark color="#F08200" v-on:click="exportToPdf">
          ...
          <v-card-text>
            ...
            <v-data-table dense :headers="headers" show-select v-model="selected" class="elevation-4" :search="search"
              :items="lab_order_results" :items-per-page="7" :loading="loading"
              loading-text="loading lab order results">
